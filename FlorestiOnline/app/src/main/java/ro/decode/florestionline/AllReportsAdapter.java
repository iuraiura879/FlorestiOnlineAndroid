...
public class AllReportsAdapter extends RecyclerView.Adapter<AllReportsAdapter.ViewHolder> {
    ...
    public AllReportsAdapter(List<NewsOrReport> myDataset, Activity act) {
        mDataset = myDataset;
        mAct = act;
    }
    ...
    @Override
    public AllReportsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                        int viewType) {
        // create a new view
        View v = null;
        ...
        if( viewType == 2)
            v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.simple_item_bottom, parent, false);
        ...
        ViewHolder.IMyViewHolderClicks listener = new ViewHolder.IMyViewHolderClicks() {
            ...
            public void onClick(View caller) {
                if(pos > 0)
                {
                    ...
                    ((MainActivity)mAct).openReportDetail();
